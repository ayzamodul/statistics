...
@section('title', 'Ayzasoft')
@section('content')
    <header class="page-header" style="width: 110%;margin-left: -5%">
        <div class="row-fluid" >
            <h2 class="no-margin-bottom"  id="h2" style="margin-left: 3%" >&nbsp; Başlangıç</h2>
        </div>
    </header>

    <section class="dashboard-header animated zoomIn" style="animation-duration: 1.5s;">
